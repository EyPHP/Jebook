...
<div class="emailBox">
    <div class="email">
        <a class="emailLogo" href="javascirpt:;"><img src=""></a>
        <p>尊敬的<?php echo e($username); ?>，您好！</p>
        <div class="content">
            <p>点击链接即可激活您的Jebook账号,</p>
            <p><a href="<?php echo e($token); ?>"><?php echo e($token); ?></a></p>
            <p>为保障您的帐号安全，请在24小时内点击该链接，您也可以将链接复制到浏览器地址栏访问。如果您并未尝试激活邮箱，请忽略本邮件，由此给您带来的不便请谅解。</p>
            <br>
            <br>
            <p class="last">本邮件由系统自动发出，请勿直接回复！</p>
        </div>
        <p class="emailCopy">Copyright© <?php echo date('Y',time()); ?> Jebook  All rights reserved</p>
    </div>
</div>
</body>
</html>